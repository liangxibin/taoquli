...
<div class="body">
	...
	<p class="nvyong_m">
        <a href="<?=wap_l('tao','list',array('q'=>'数码'))?>"><font style="background:#f25f55;color:#fff">数码</font></a>
        <a href="<?=wap_l('tao','list',array('q'=>'热卖'))?>">热卖</a>
        <a href="<?=wap_l('tao','list',array('q'=>'男装'))?>"><font style="background:#3366ff;color:#fff">男装</font></a>
        <a href="<?=wap_l('tao','list',array('q'=>'女装'))?>"><font color="#f25f55">女装</font></a>
        ...
        <a href="<?=wap_l('tao','list',array('q'=>'美妆'))?>"><font color="#f25f55">美妆</font></a>
