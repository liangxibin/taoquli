...
<?=AD(10)?>
  ...
  <td width="57%" valign="top">
    ...
    <?=TBMONEY?>兑换 ：<b style=" color:#f25f55; font-size:16px"><?=$good['_jifenbao']?></b>&nbsp;
    <?php }else{?>
    <?=TBMONEY?>兑换 ：不参与
    <?php }?>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <?php if($good['jifen']>0){?>
    积分兑换 ：<b style=" color:#f25f55; font-size:16px"><?php echo $good['jifen'];?></b>&nbsp;点
    <?php }else{?>
    积分兑换 ：不参与
    <?php }?>
    </div>
    <div style="line-height:35px;margin-top:3px;font-size: 14px;color: #999999;">剩余库存 ：<b style=" color:#f25f55; font-size:16px"><?=$good['num']?></b>&nbsp;件</div>
    <?php if($good['sdate']>0){?>
    <div style="line-height:35px;margin-top:3px;font-size: 14px;color: #999999;">开始时间 ：<b style=" color:#f25f55; font-size:16px"><?=$good['_sdate']?></b></div>
    <?php }?>
    <?php if($good['edate']>0){?>
    <div style="line-height:35px;margin-top:3px;font-size: 14px;color: #999999;">结束时间 ：<b style=" color:#f25f55; font-size:16px"><?=$good['_edate']?></b></div>
    <?php }?>
