  ...
  <div class="mainbody1000">
    ...
    <div class="w1000">
      <div class="home_left home-shop">
        <div class="clearfix" style="height:198px;border:1px solid #dfdfdf;background:#FFF; position:relative;">
          <ul style="margin-left:8px;">
            <li style="float:left;padding-top:8px;text-align:center;color:#999;margin:0 11px 7px 0; z-index:999;">
                <img src="//alp.alicdn.com/1476310476060.png" alt="" width="760" height="180">
            </li>
          </ul>
        </div>
      </div>
      <div class="chongzhi" style="position:relative">
        ...
        <iframe frameborder="0" style="height:200px; width:210px" src="http://www.taobao.com/go/app/tdjwidget/recharge_210x200.php?w=unionapijs&pvid=ee3863aeecc46540f451da6c534e9645&b=display_501_0_0_0_0&pid=mm_16653469_9254108_31386608&unid=0&width=210&height=200"></iframe>
      ...
      <div id="ddlanmu">
        <div class="ddlanmu_c">
          <ul class="home-tab clearfix">
            ...
            <li <?php if($vo['code']==$_GET['code']||$key==0){?>class="current"<?php }?> code="<?=$vo['code']?>">
                <span code="<?=$vo['code']?>" class="home-tab-super c_border">
                    <strong class="c_fcolor"><?=$vo['title']?></strong>
                </span>
            </li>
            <?php }?>
          </ul>
