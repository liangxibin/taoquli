...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
    ...
    <td>&nbsp;<a target="_blank" style="text-decoration:underline" href="https://oauth.taobao.com/authorize?response_type=token&client_id=<?=$webset['taoapi']['jssdk_key']?>">点击获取淘宝授权</a><span style="color:#f25f55">&nbsp;　请使用网站填写的“淘宝账号”登陆获取　<a href="index.php?mod=tradelist&act=set">查看</a></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><span style="color:#f25f55">&nbsp;检测主机是否支持openssl组件，可将淘宝授权延长到30天</span> <a style="text-decoration:underline" href="<?=u(MOD,ACT,array('test_ssl'=>1))?>">点击检测</a></td>
  </tr>
  <tr>
    <td height="35" align="right">第五步（可选）：</td>
    <td>&nbsp;<?=html_radio(array(0=>'关闭',1=>'自动'),$webset['taobao_session']['auto'],'taobao_session[auto]')?>&nbsp;<span style="color:#f25f55">如果可用则开启，不可用则关闭。点上面“保存设置”即可</span></td>
  </tr>
  <tr style="color:#666">
