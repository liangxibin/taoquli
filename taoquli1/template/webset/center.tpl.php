...
<div style="width:100%;">
  <div class="c_left">
    ...
    <?php if(DLADMIN!=1){?>
    <div class="box_l">
        <div class="c_biaoti" >&nbsp;站务快捷  <span style="font-size:12px; font-weight:normal"><a style="color:#f25f55; cursor:pointer" href="http://bbs.duoduo123.com/read-1-1-197798.html" target="_blank" >设置向导 </a></span></div>
        <ul class="kuaijie">
 ...
 <div  class="center_tj">
      ...
      <div class="box_l">
        ...
        <ul class="shuju">
		  <li title="网站所有项目的佣金收益">网站收益：<b style="color:#f25f55"><?=($web_zsy)?> 元</b></li>
		  <li title="总收益-已支出">预计净收益：<b style="color:#f25f55" ><?=round($web_zsy-$zhizhu_sum,2)?> 元</b></li>
      ...
      <div class="box_l">
        ...
        <ul class="shuju">
		  <li>总交易额：<b style="color:#f25f55"><?=$tao_goods_sum?> 元</b></li>
		  <li>总收益：<b style="color:#f25f55"><?=$taobao_zsy?> 元</b></li>
		  <li>总交易量：<b style="color:#f25f55"><?=$taobao_tradenum?> 条</b></li>
		  <li>已确认订单：<b style="color:#f25f55"><?=$tradenum_ok?> 条</b></li>
		  <li>未认领订单：<b style="color:#f25f55"><?php echo $taobao_tradenum-$tradenum_ok;?> 条</b></li>
		</ul>	
        <div style="clear:both"></div>
      </div>
      ...
      <div class="box_l">
        ...
        <ul class="shuju">
		  <li>总交易额：<b style="color:#f25f55"><?=$pai_goods_sum?> 元</b></li>
		  <li>总收益：<b style="color:#f25f55"><?=$paipai_zsy?> 元</b></li>
		  <li>总交易量：<b style="color:#f25f55"><?=$paipai_tradenum?> 条</b></li>
		  <li>已确认订单：<b style="color:#f25f55"><?=$paipai_tradenum_ok?> 条</b></li>
		  <li>未认领订单：<b style="color:#f25f55"><?php echo $paipai_tradenum-$paipai_tradenum_ok;?> 条</b></li>
		</ul>	
        <div style="clear:both"></div>
      </div>
      <?php }?>
      <div class="box_l">
        ...
        <ul class="shuju">
		  <li>总交易额：<b style="color:#f25f55"><?=$mall_goods_sum?> 元</b></li>
		  <li>总收益：<b style="color:#f25f55"><?=$mall_zsy?> 元</b></li>
		  <li>总交易量：<b style="color:#f25f55"><?=$mall_tradenum?> 条</b></li>
		  <li>有效订单：<b style="color:#f25f55"><?=$mall_order_ok?> 条</b></li>
		  <li>未核对订单：<b style="color:#f25f55"><?=$mall_order_no?> 条</b></li>
          <li>未认领订单：<b style="color:#f25f55"><?=$mall_no_user?> 条</b></li>
		</ul>	
        <div style="clear:both"></div>
      </div>
      ...
      <div class="box_l">
        ...
        <ul class="shuju">
		  <li>总佣金：<b style="color:#f25f55"><?=$taskyj['commission']?> 元</b></li>
		  <li>会员收益：<b style="color:#f25f55"><?=$taskyj['point']?> 元</b></li>
          <li>网站收益：<b style="color:#f25f55"><?=$tasksy?> 元</b></li>
		  <li>总订单：<b style="color:#f25f55"><?=$tasknum?> 条</b></li>
		  <li>确认订单：<b style="color:#f25f55"><?=$tasknum_1?> 条</b></li>
		</ul>	
        <div style="clear:both"></div>
      </div>
      <?php }?>
