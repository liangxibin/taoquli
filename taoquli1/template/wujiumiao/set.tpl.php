...
<tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input style="width:30px" name="wujiumiaoapi[cache_time]" value="<?=$webset['wujiumiaoapi']['cache_time']?>" />&nbsp;<span style="color:#f25f55">单位(小时)，设为为0即为不缓存，目录为data/temp/wujiumiaoapi。</span> <input type="button" value="删除缓存" onclick="javascript:openpic('../<?=u('cache','del',array('admin'=>'1','do'=>'wujiumiao'))?>','upload','450','350')" /></td>
  </tr>
  <tr>
