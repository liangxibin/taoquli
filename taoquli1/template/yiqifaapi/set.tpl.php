...
<table id="addeditable" align="center" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<input style="width:30px" name="yiqifaapi[cache_time]" value="<?=$webset['yiqifaapi']['cache_time']?>" />&nbsp;<span style="color:#f25f55">单位(小时)，设为为0即为不缓存，目录为data/temp/yiqifaapi。</span> <input type="button" value="删除缓存" onclick="javascript:openpic('../<?=u('cache','del',array('admin'=>'1','do'=>'yiqifa'))?>','upload','450','350')" /></td>
  </tr>
  <tr>
